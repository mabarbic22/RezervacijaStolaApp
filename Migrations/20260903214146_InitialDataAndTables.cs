...
{
    /// <inheritdoc />
    public partial class InitialDataAndTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Desks",
                columns: new[] { "Id", "DeskNumber", "RoomFloorId" },
                values: new object[,]
                {
                    { 1, 1, 1 },
                    { 2, 2, 1 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 12, 40, new DateTime(2026, 11, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), 11 },
                    { 13, 26, new DateTime(2026, 7, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 18 },
                    { 14, 33, new DateTime(2026, 9, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), 27 }
                });
